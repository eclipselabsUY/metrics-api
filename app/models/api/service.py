...
class ServiceType(Base):
    ...
    kind = Column(
        Enum(ServiceKind, name="service_kind_enum"),
        nullable=False,
        index=True,
    )
    services = relationship("Service", back_populates="service_type", lazy="selectin")
...
class Service(Base):
    ...
    service_type = relationship("ServiceType", back_populates="services", lazy="joined")
